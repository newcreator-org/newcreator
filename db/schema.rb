...
ActiveRecord::Schema.define(version: 2019_05_15_194320) do
  ...
  create_table "textbooks", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci", force: :cascade do |t|
    t.string "title"
    t.string "uuid"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
